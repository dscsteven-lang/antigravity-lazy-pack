...
執行指令格式範例：
```powershell
powershell -ExecutionPolicy Bypass -File "g:\我的雲端硬碟\AntiGravity2\懶人包\Create-AntiGravityProject.ps1" -ProjectName "專案名稱" -FolderName "資料夾名稱" -Personality "個性化設定描述" -EnableNotebookLM -EnableGitHubCLI -EnableDrawGuideline
```
